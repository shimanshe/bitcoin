...
def SegwitV0SignatureHash(script, txTo, inIdx, hashtype, amount, log=False):
    ...
    if not (hashtype & SIGHASH_ANYONECANPAY):
        ...
        # if log: print("hashPrevouts:"+ser_uint256(hashPrevouts).hex())
    ...
    if (not (hashtype & SIGHASH_ANYONECANPAY) and (hashtype & 0x1f) != SIGHASH_SINGLE and (hashtype & 0x1f) != SIGHASH_NONE):
        ...
        # if log: print("hashSequence:"+ser_uint256(hashSequence).hex())
    ...
    if ((hashtype & 0x1f) != SIGHASH_SINGLE and (hashtype & 0x1f) != SIGHASH_NONE):
        ...
        # if log: print("hashOutputs:"+ser_uint256(hashOutputs).hex())
